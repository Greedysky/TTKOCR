...
"%base%\pvk2pfx.exe" -pvk %temp%\CbipSetupKey.pvk -spc %temp%\CbipSetupKey.spc -f -pfx %userprofile%\Desktop\TTKOCR.pfx
"%base%\signtool.exe" sign /f %userprofile%\Desktop\TTKOCR.pfx  /t "http://timestamp.verisign.com/scripts/timstamp.dll" /d "TTKOCR" %1
del %temp%\CbipSetupKey.* >nul 2>nul
del %userprofile%\Desktop\TTKOCR.pfx >nul 2>nul
