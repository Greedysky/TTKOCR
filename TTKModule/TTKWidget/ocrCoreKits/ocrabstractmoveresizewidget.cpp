...
OCRAbstractMoveResizeWidget::OCRAbstractMoveResizeWidget(QWidget *parent)
    : QWidget(parent)
{
...
void OCRAbstractMoveResizeWidget::mouseMoveEvent(QMouseEvent *event)
{
...
void OCRAbstractMoveResizeWidget::mouseReleaseEvent(QMouseEvent *event)
{
...
void OCRAbstractMoveResizeWidget::moveDirection()
{
    switch(m_direction)
    {
