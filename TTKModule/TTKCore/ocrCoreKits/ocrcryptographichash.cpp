...
QString OCRCryptographicHash::encrypt(const QString &data, const QString &key)
{
    return xxteaEncrypt(data, key).toUtf8().toBase64();
}

QString OCRCryptographicHash::decrypt(const QString &data, const QString &key)
{
    return xxteaDecrypt(QByteArray::fromBase64(data.toUtf8()), key);
}

TTKString OCRCryptographicHash::xxteaEncrypt(const TTKString &data, const TTKString &key)
{
...
TTKString OCRCryptographicHash::xxteaDecrypt(const TTKString &data, const TTKString &key)
{
...
uchar *OCRCryptographicHash::fixKeyLength(uchar *key, xxtea_uint keyLength)
{
...
xxtea_uint *OCRCryptographicHash::xxteaToUintArray(uchar *data, xxtea_uint len, int includeLength, xxtea_uint *retLength)
{
...
uchar *OCRCryptographicHash::xxteaToByteArray(xxtea_uint *data, xxtea_uint len, int includeLength, xxtea_uint *retLength)
{
    xxtea_uint i, n, m;
    uchar *result;
...
uchar *OCRCryptographicHash::doXxteaEncrypt(uchar *data, xxtea_uint len, uchar *key, xxtea_uint *retLength)
{
    uchar *result;
...
uchar *OCRCryptographicHash::doXxteaDecrypt(uchar *data, xxtea_uint len, uchar *key, xxtea_uint *retLength)
{
    uchar *result;
    xxtea_uint *v, *k, vlen, klen;
...
uchar *OCRCryptographicHash::xxteaEncrypt(uchar *data, xxtea_uint dataLength, uchar *key, xxtea_uint keyLength, xxtea_uint *retLength)
{
    uchar *result;
    *retLength = 0;
...
uchar *OCRCryptographicHash::xxteaDecrypt(uchar *data, xxtea_uint dataLength, uchar *key, xxtea_uint keyLength, xxtea_uint *retLength)
{
    uchar *result;
    *retLength = 0;
